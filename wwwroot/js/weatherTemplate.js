function WeatherLoader() {
    ...
    function LoadWeatherData() {
        ...
        let lat = "lat=30.733315&";
        let lon = "lon=76.779419&";
        ...
        fetch(file)
            ...
            .then((data) => {
                ...
                let time3 = formatAMPM(timeNow + 3);
                let time4 = formatAMPM(timeNow + 4);
                let time5 = formatAMPM(timeNow + 5);
                ...
                document.getElementById("wrapper-now").innerHTML = timeNoww;
